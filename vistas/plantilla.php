...
<head>
  ...
  <title>LA TIENDA del grifo COPAR</title>

  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <link rel="icon" href="vistas/img/plantilla/logo-pestañas.png" >
  ...
  <!-- rebuilder -->
  <link rel="stylesheet" href="vistas/css_rebuilder/estilos.css">
 ...
 <!-- Icommons -->
  <link rel="stylesheet"href="vistas/bower_components/icomoon/style.css"/>
